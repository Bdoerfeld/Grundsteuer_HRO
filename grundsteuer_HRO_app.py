...
st.write("""
1. **Berechnung der alten Grundsteuer**: Der alte Grundsteuermessbetrag wird mit dem alten Hebesatz (520 v.H.) multipliziert.
2. **Berechnung der neuen Grundsteuer**: Der neue Grundsteuermessbetrag wird mit dem neuen Hebesatz (438 v.H.) multipliziert.
